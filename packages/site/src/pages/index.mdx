...
- **Bundler agnostic** - Showcase should be able to work with any bundler.
- **Browser automation agnostic** - Showcase should be able to work with any browser automation tool.
- **CI agnostic** - Showcase should be able to work with any CI and will always be able to run locally.
